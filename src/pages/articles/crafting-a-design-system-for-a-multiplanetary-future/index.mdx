...
export const meta = {
  ...
  description:
    ' stay ahead of the curve when it comes to visual design, but for Planetaria we needed to create a brand that would still inspire us 100 years from now when humanity has spread across our entire solar system.',
}
...
rqwerwqereqwrewqrweqqrwer naufraga sua adit partibus celanda
